            ...
            <div className="overflow-x-auto">
                ...
                <tbody className="divide-y divide-gray-800">
                    ...
                    <tr className="hover:bg-gray-800 transition-colors">
                        ...
                        <td className="px-6 py-4 text-sm text-white font-medium">Email
                        </td>
                        <td className="px-6 py-4 text-sm text-white font-medium">Phone
                        </td>
                        <td className={`px-3 py-1 rounded-full text-xs font-semibold`}>Active
                        </td>
