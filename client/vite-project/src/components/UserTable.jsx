...
function UserTable({
    ...
    return (<div className="bg-gray-900 rounded-lg overflow-hidden border
        border-gray-800">
            <div className="overflow-x-auto">
                <table className="w-full">
                    <thead className="bg-gray-800 border-b border-gray-700">
                        ...
                        text-gray-300">Name</th>
                        <th className="px-6 py-4 text-left text-sm font-semibold
                        text-gray-300">Email</th>
                        <th className="px-6 py-4 text-left text-sm font-semibold
                        text-gray-300">Phone</th>
                        <th className="px-6 py-4 text-left text-sm font-semibold
                        text-gray-300">Status</th>
                        <th className="px-6 py-4 text-left text-sm font-semibold
                        text-gray-300">Created</th>
                        <th className="px-6 py-4 text-left text-sm font-semibold
                        text-gray-300">Action</th>
                        </tr>
                    </thead>
                ...
                <tbody className="divide-y divide-gray-800">
                    ...
                    {users.map((u, indx)=>(
                        ...
                        <td className="px-6 py-4 text-sm text-white font-medium">{u.email}
                        </td>
                        <td className="px-6 py-4 text-sm text-white font-medium">{u.phone}
                        </td>
                        ...
                        <td className="px-6 py-4 text-sm text-gray-400">{new Date(u.
                        ...
                        <td className="px-6 py-4 text-center">
                            <div className="flex justify-center gap-2">
                                ...
                                hover:bg-green-400 transition-all font-semibold" onClick=
                                    {()=> onEdit(u)}>
                                    <Edit size={16} />Edit
                                </button>
                                <button className="flex items-center gap-1 px-3 py-1.5
            ...
            {/* Conditional Rendering */}
           {users.length > 0 &&(
             <div className="px-6 py-4 bprder-t border-gray-800 flex justify-between
            items-center bg-gray-800">
                ...
                <div className="flex gap-2">
                    ...
                    disabled:opacity-50" onClick={()=> onPageChange(currentPage -1)}
                   disabled={currentPage === 1} >
                    ...
                    {[...Array(totalPages)].map((_, i)=>{
                        ...
                        if(
                            ...
                            return (<button className={`px-3 py-2 rounded-lg ${
                                currentPage === p
